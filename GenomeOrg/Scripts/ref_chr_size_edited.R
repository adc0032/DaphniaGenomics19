...
#ggplot2 with data
dat$ï..chromosome <- factor(dat$ï..chromosome,levels = c("chr_10", "chr_7", "chr_2", "chr_8", "chr_3", "chr_9", "chr_5", "chr_12",
                                                         "chr_1", "chr_6", "chr_4", "chr_11"))

ggplot(dat, aes(x = ï..chromosome, y = chr_size..Mbp.)) +  geom_col(color = 'darkgray', fill = 'white', width = 0.2) + labs (x = 'Chromosome number', y = 'Chromosome size (Mbp)', title = 'Reference chromosome sizes')
